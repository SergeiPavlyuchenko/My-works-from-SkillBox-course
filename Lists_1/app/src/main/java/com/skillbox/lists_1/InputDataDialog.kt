...
class InputDataDialog : DialogFragment() {
    ...
    private val binding by viewBinding(DialogInputDataBinding::bind)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dialogViews = requireActivity().layoutInflater.inflate(R.layout.dialog_input_data, null)
    ...
    private fun dialogLaunch(
        ...
        return AlertDialog.Builder(requireContext())
            ...
            .setView(R.layout.dialog_input_data)
